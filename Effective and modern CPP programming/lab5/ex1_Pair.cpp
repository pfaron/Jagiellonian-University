...
public:
    ...
    [[nodiscard]] constexpr T getFirst() const;           // returns first, mark it inline
    [[nodiscard]] constexpr S getSecond() const;          // returns second, mark it inline
    [[nodiscard]] constexpr Pair<S, T> reverse() const;    // returns a reversed Pair
