...
int main() {
    auto fp1 = sqrtn;
    double (*fp1_)(int, double) = sqrtn;
    auto fp2 = power;
    double (*fp2_)(double, double) = power;
    auto fp3 = function<decltype(fp1), decltype(fp2)>;
    double (*fp3_)(int, double, double, double (int, double),
                   double (double, double)) = function<decltype(fp1), decltype(fp2)>;
